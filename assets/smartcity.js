...
function placeCamera(camera, callback) {
    ...
    const infoWindow = new google.maps.InfoWindow({
        content: `<h3>${camera.name}</h3><iframe src="${camera.videoUrl}"></iframe><p>${camera.description} <a href="${camera.videoUrl}" target="_blank" rel="noopener">(new tab)</a></p>`,
    });
...
>>>>>>> 073c8c4be5e9ac07a87f70cba1b423d4b921cfb4
